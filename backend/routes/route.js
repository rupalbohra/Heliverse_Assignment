...
router.get("/availableSlots/:day", availableSlots);
router.get("/getFullTimeTable", getFullTimeTable);
//
...
router.get("/Assignments/:class/:subject", getAssignmentsByClassAndSubject);
//
